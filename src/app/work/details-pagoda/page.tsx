            ...
            <div className='mx-auto p-0 grid gap-6'>
              ...
              <div className='grid md:grid-cols-3 gap-4 place-items-start'>
                <div className='md:col-span-1 md:sticky top-24'>
                  ...
                  <h1 className='text-3xl font-bold'>Pagoda Asian Grill</h1>

                  <p className='mt-1 text-sm text-gray-500'>2024</p>

                  <p className='mt-4'>
                    website:{" "}
                    <Link
                      href='https://pagodaasiangrill.com/'
                  ...
                  <div className='py-4 space-y-1'>
                    ...
                    <p>
                      Led conception, technical build, and responsive design for
                      a &quot;coming soon&quot; landing page, completed in just
                      three days.
                    </p>
                  </div>
                ...
                <div className='md:col-span-2'>
                  ...
                  <div className='w-full'>
                    <Image
                      src='/images/details/pagoda/Screen-Shot-1.jpg'
                      alt=''
