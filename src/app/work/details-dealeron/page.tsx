...
export const metadata: Metadata = {
  title: "details-dealeron",
  description: "Super cool web engineer / developer",
};

export default function detailsDealeron() {
  return (
    <>
              ...
              <div className='grid md:grid-cols-3 gap-4 place-items-start'>
                <div className='md:col-span-1 md:sticky top-24'>
                  ...
                  <p className='mt-4'>
                    ...
                    <br />
                    <Link
                      href='https://www.ricartford.com/ford-f-150-roush/'
                      aria-label='view my work'
                      target='_blank'
                    >
                      Ford F-150 Roush
                  ...
                  <div className='py-4 space-y-1'>
                    ...
                    <p>
                      Custom migration from Sincro to DealerOn, designing
                      mobile-responsive pages while meeting WCAG and ADA
                  ...
                  <div>
                    ...
                    <div className='icons py-4 flex justify-start'>
                      ...
                      <div className='has-tooltip'>
                        ...
                        <VscVscode className='text-blue-500' title='vscode' />
                      </div>
                      {/* <div className='has-tooltip'>
                        <span className='tooltip rounded shadow-lg p-1 bg-gray-100 text-primary -mt-8'>
                          github
                ...
                <div className='md:col-span-2'>
                  ...
                  <div className='w-full'>
                    ...
                    <br />
                    <Image
                      src='/images/details/dealeron/Screen-Shot-2.jpg'
                      alt=''
                      className='w-full mb-4 rounded-lg shadow-md'
                      width={800}
                      height={1200}
