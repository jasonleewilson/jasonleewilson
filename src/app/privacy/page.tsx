...
export default function Privacy() {
  return (
    <main className='flex-grow container mx-auto mt-20 px-4 lg:px-4'>
      ...
      <ul className='mb-4'>
        ...
        <li className='mb-4'>
          <p>
            ...
            this Agreement) refers to jasonleewilson.
          </p>
        </li>
        <li className='mb-4'>
          <p>
        ...
        <li className='mb-4'>
          <p>
            <strong>Website</strong> refers to jasonleewilson, accessible from{" "}
            <a
              href='https://jasonleewilson.com'
              rel='external nofollow noopener'
              target='_blank'
            >
              https://jasonleewilson.com
            </a>
          </p>
        </li>
        <li className='mb-4'>
      ...
      <h3 className='mb-4'>Delete Your Personal Data</h3>
      <p className='mb-4'>
      ...
      <h4 className='mb-4'>Business Transactions</h4>
      <p className='mb-4'>
      ...
      <h4 className='mb-4'>Other legal requirements</h4>
      <p className='mb-4'>
      ...
      <h3 className='mb-4'>Security of Your Personal Data</h3>
      <p className='mb-4'>
      ...
      <ul className='mb-4'>
        <li className='mb-4'>
          ...
          <a
            href='https://jasonleewilson.com/contact'
            rel='external nofollow noopener'
            target='_blank'
          >
            https://jasonleewilson.com/contact
          </a>
        </li>
      </ul>
    </main>
